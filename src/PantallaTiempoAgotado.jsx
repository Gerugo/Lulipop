...
export default function PantallaTiempoAgotado({ perfil, minutosJugadosHoy, onVolverAPerfiles, onDesbloquear }) {
  ...
  return (
    <div style={{
      ...
      <div className="anim-pop-tiempo" style={{
        ...
        <div className="anim-flota-luna" style={{ fontSize: '5rem' }}>🌙</div>
        <h2 style={{ color: '#334155', fontSize: '1.8rem', fontWeight: '900', margin: '10px 0 8px 0' }}>
          ¡Hora de descansar, {perfil?.nombre}!
        </h2>
        <p style={{ color: '#64748B', fontSize: '1.05rem', fontWeight: '600', margin: '0 0 20px 0', lineHeight: '1.4' }}>
